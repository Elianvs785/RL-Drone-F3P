...
class DroneGame:
    ...
    def _calculate_reward(self):
        ...
        dx = abs(self.drone.x - self.platform.x)
        hauteur_reelle = self.platform.y - self.drone.y
        
        hauteur_ideale = 10000.0 / (dx + 0.1) 
        erreur_trajectoire = abs(hauteur_reelle - hauteur_ideale)
        reward -= erreur_trajectoire / 1000.0 
